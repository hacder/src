$(document).ready(function(){
	...
	$("#add-options").click(function(){
		...
		if(numOptions>=maxOptions){
			tipsAlert("Lighttpd自定义报警指标数量不能超过"+maxOptions);
		}else{
	...
	$("#lighttpd-save").click(function(){
		...
		var itemconfig = getLighttpdConfig();
		var url = "index.php?c=monitor&a=lighttpd_monitor";
		$.post(url,{
			'itemname':itemname,
			'urlname':urlname,
	...
	$("#lighttpd-edit").click(function(){
		...
		var url = "index.php?c=monitor&a=monitor_lighttpd_edit";
		$.post(url,{
			'itemid':itemid,
			'itemname':itemname,
			'urlname':urlname,
