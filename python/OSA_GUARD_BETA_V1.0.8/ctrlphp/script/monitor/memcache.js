$(document).ready(function(){
	...
	$("#add-options").click(function(){
		...
		if(numOptions>=maxOptions){
			tipsAlert("Memcache自定义报警指标数量不能超过"+maxOptions);
		}else{
	...
	$("#memcache-save").click(function(){
		...
		var itemconfig = getMemcacheConfig();
		var url = "index.php?c=monitor&a=memcache_monitor";
		$.post(url,{
			'itemname':itemname,
			'urlname':urlname,
	...
	$("#memcache-edit").click(function(){
		...
		var url = "index.php?c=monitor&a=monitor_memcache_edit";
		$.post(url,{
			'itemid':itemid,
			'itemname':itemname,
			'urlname':urlname,
