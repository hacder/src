$(document).ready(function(){
	...
	$("#add-options").click(function(){
		...
		if(numOptions>=maxOptions){
			tipsAlert("Nginx自定义报警指标数量不能超过"+maxOptions);
		}else{
	...
	$("#nginx-save").click(function(){
		...
		var itemconfig = getNginxConfig();
		var url = "index.php?c=monitor&a=nginx_monitor";
		$.post(url,{
			'itemname':itemname,
			'urlname':urlname,
	...
	$("#nginx-edit").click(function(){
		...
		var url = "index.php?c=monitor&a=monitor_nginx_edit";
		$.post(url,{
			'itemid':itemid,
			'itemname':itemname,
			'urlname':urlname,
