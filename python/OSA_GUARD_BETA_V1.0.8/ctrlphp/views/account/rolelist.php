...
<!--右侧内容开始-->
		...
		<!--右侧content开始-->
			<div class="edit_list">
			<!--one-->
				<div class="rightcon_title">角色列表</div>
				<div class="rightcon_mid">
<!--						<div class="right20"><a href="index.php?c=account&a=roleadd" class="add_new"><i class="icon_add_arrow"></i><span>创建新角色</span></a>-->
<!--						</div>-->
					<div id="details_1" class="details_control">
						...
						<div class="action">
							...
							<div class="btn-toolbar left">
								<div class="btn_green1 left"><a href="index.php?c=account&a=roleadd"><span class="spanL">创建新角色</span><span class="spanR"></span></a></div>
								<div class="btn_gray1 left"><a id="role-pause"><span class="spanL">暂停</span><span class="spanR"></span></a></div>
								<div class="btn_gray2 left"><a id="role-open"><span class="spanL">启用</span><span class="spanR"></span></a></div>
								<div class="btn_gray3 left"><a id="role-del"><span class="spanL">删除</span><span class="spanR"></span></a></div>
							</div>
					...
					<?php include 'views/account/role_ajax.php';?>
					</div>
				</div>
