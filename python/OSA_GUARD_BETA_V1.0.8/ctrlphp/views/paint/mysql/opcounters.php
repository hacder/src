...
<div class="main">
<!--左侧菜单开始-->
	<?php include 'views/paint/mysql/menu.php'?>
<!--左侧菜单结束-->
<!--右侧内容开始-->
	<div class="mainright" id="mainright">
	<!--右侧title开始-->	
		<div class="currtitle">
			<div class="placing"><span>当前位置：</span><span>图形报表</span> <span>&gt;</span><span>Mysql查询吞吐率</span></div>
		</div>
		<!--右侧title结束-->
		<!--右侧content开始-->
		<div class="edit_list">
						        ...
						        chart = new Highcharts.Chart({
						            ...
						            tooltip: {
						                formatter: function() {
						            		...
						            		return ''+'时间:'+date+'<br >'+this.series.name+': '+ this.y +'/s';					                  
						                }
						            },
						            plotOptions: {
						                area: {
