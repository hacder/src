...
<!--右侧内容开始-->
	...
	<!--右侧title开始-->	
		<div class="currtitle">
			<div class="placing"><span>当前位置：</span><span>图形报表</span> <span>&gt;</span> <span>服务器磁盘I/O </span></div>
		</div>
		<!--右侧title结束-->
		<!--右侧content开始-->
		<div class="edit_list">
			...
			<div class="rightcon_mid"  id="rightcon_mid" >
				<div class="wids_container" >
					...
					<div id="<?php echo "diskio".$i;?>" class="wids_cols ui-sortable" style="width:70%;height:280px;padding:0;">
						<script type="text/javascript">
						 	var chart;
						    $(document).ready(function() {
						        chart = new Highcharts.Chart({
						            chart: {
						                renderTo: '<?php echo "diskio".$i;?>',
						                type: 'area'
						            },
						            credits : {
										enabled:false
						            ...
						            tooltip: {
						                formatter: function() {
						            		...
						            		return ''+'时间:'+date+'<br >'+this.series.name+':'+ this.y+'Kbytes';					                  
						                }
						            },
						            plotOptions: {
						                area: {
