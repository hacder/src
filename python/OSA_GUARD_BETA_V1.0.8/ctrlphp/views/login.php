...
<body>
  <div id="login">
       ...
       <p><a href="" id="sethome">设为首页</a> | <a href="" id="collect">收藏</a> | <a href="http://bbs.osapub.com/forum.php" target="_blank">帮助</a></p>
    </div>
       <div  class="login_box">
           <div class="login_con">
               ...
               <p class="lab">
               		<span class="text_bg">
              			<label for="username" id="nameprev">邮箱/手机号/用户名</label>
               			<input name="1" type="text" value="<?php echo $_COOKIE['remember'] == 1?$_COOKIE['username']:'';?>"  id="username" />
               		</span>
               </p>
               <p class="lab">
               		<span class="text_bg">
           ...
           <p class="login_last">版权所有：OSA开源团队 <a href="http://wiki.osapub.com/OSA%E5%BC%80%E6%BA%90%E8%AE%B8%E5%8F%AF%E5%8D%8F%E8%AE%AE" target="_blank">《OSA开源许可协议》</a>| 技术支持：OSA开源团队 群号：22250846(技术支持)<br />
