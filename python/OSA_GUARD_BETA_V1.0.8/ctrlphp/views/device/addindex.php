...
<!--右侧内容开始-->
		...
		<!--右侧title开始-->	
			<div class="currtitle">
				<div class="placing"><span>当前位置：</span><span>设备管理</span> <span>&gt;</span> <span>添加设备</span></span></div>
			</div>
		<!--右侧title结束-->
		<!--右侧content开始-->
			<div class="edit_list">
			<!--one-->
					<div class="rightcon_title">添加设备</div>
					<div class="rightcon_mid">	
						<div class="edit_con">
							 <div>
								<label class="label5">*设备名称：</label><input type="text" class="style17" id="devname" />
								...
								<div id="div_sel2" style="float:left;">
									<div class="select_box" style="z-index: 1; position: relative; width: 116px;">
										<input id="typename" name="tag_input" class="tag_select tag_input" maxlength="8" value="请选择类型">
							...
							<div class="clear"></div>
								<label class="label5">*IP地址：</label><input type="text" class="style5" id="ipname"> 
			...
			<!--two-->
					...
					<div class="rightcon_mid">			
						<div class="edit_con">
							<label class="label5">业务描述：</label><input type="text" class="style5" id="workdes"/>
							<div class="clear"></div>
							...
							<div id="div_sel2" style="float:left;">
								<div class="select_box" style="z-index: 1; position: relative; width: 116px;">
									<input id="roomname" name="tag_input" class="tag_select tag_input" maxlength="8" value="请选择机房">
									<ul class="tag_options" style="position: absolute; z-index: 999; width: 116px; display: none;">
										<li class="open_selected tag_li">请选择机房</li>
							...
							<input type="text" class="style5" id="shelvetime">
							<div class="clear"></div>
							<p class="light">上架时间用来记录服务器最初上架的时间，方便管理。</p>
							<div class="clear"></div>
							<label class="label5">设备标签：</label><input type="text" id="devlabel" class="style5">
							<div class="clear"></div>
							<p class="light">标签可以用来更好的搜索服务器！</p>
							<div class="clear2"></div>
							<label class="label5">采购价格：</label><input type="text" class="style5" value="0" id="devprice">
							<div class="clear"></div>
							<p class="light">采购价格是指在采购设备时所花费的资金，单位：元,填写后可以进行资源预算分析。</p>
							<div class="clear"></div>
							<label class="label5">托管价格：</label><input type="text" class="style5" value="0" id="tgprice">
							<div class="clear"></div>
							<p class="light">托管价格是指在每月设备托管产生的费用，单位：元，例如：300元/月</p>
							<div class="clear"></div>
							<label class="label5">设备详情：</label><textarea class="textarea2" id="devdetail"></textarea>
							<div class="clear"></div>
