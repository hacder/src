	...
	<div class="mainright" id="mainright">
		...
		<div class="edit_list">
			...
			<div class="rightcon_mid">
				...
				<div class="left"><input type="text" class="style5" placeholder="请输入FTP服务的主机域名或者IP" id="itemurl"/><span class="tips" style="margin-left:6px;"></span></div>
				<div class="clear"></div> 
				...
				<div class="left"><input type="text" class="style5" value="21" id="ftpport"/><span class="tips" style="margin-left:6px;"></span></div>
				<div class="clear"></div> 
				<label class="label_more">&nbsp;</label>
				...
				<div class="left">
					<input type="radio" class="radio1 ftp-radio" name="ftp-radio" value="0"/>
					<label class="label_c2">需要身份验证</label>
					<input type="radio" class="radio1 ftp-radio" name="ftp-radio" checked="checked" value="1"/>
					<label class="label_c2">匿名登录</label>
				</div>
				<div class="clear"></div> 
				<div class="ftp-identity" id="ftp-identity" style="display:none;">
					<label class="label_more"></label>
					<div class="light0">请选择FTP身份验证方式。</div>
					<div class="clear"></div>
					
					<label class="label_more"><span class="red">*</span>FTP用户名：</label>
					<div class="left"><input type="text" class="style5" id="ftpuser"/><span class="tips" style="margin-left:6px;"></span></div>
					<div class="clear"></div> 
					<label class="label_more">&nbsp;</label>
					...
					<div class="left"><input type="password" class="style5" id="ftppass"/><span class="tips" style="margin-left:6px;"></span></div>
					<div class="clear"></div> 
					<label class="label_more">&nbsp;</label>
		...
		<div class="edit_submit">
			<div class="btn_green" style=""><a id="ftp-save"><span class="spanL">保存监控项目</span><span class="spanR"></span></a></div>
