...
<!--右侧内容开始-->
		...
		<div class="edit_list">
			<!--one-->
				...
				<div class="rightcon_mid">
					...
					<div class="left"><input type="text" class="style5" value="http://" id="urlname" /><span class="tips" style="margin-left:6px;margin-top:2px;"></span></div>
					...
					<div class="more_class" style="display:none;">
						<div class="window_hr"></div>
						<div class="height10"></div>
						<label class="label_more">对比关键字：</label>
						<div class="light0"><input type="text" class="style5" placeholder="请输入对比关键字" id="keyword"/></div>
						<div class="clear"></div>
						<label class="label_more">&nbsp;</label>
						<div class="light0">可以输入需要对比的关键字，多个关键定用","分割。</div>
						<div class="clear"></div>
						<label class="label_more">指定服务器：</label>
						<div class="input0"><input type="text" class="style5" placeholder="请输入域名或指定IP" id="itemip"></div>
						<div class="clear"></div>
						<label class="label_more">&nbsp;</label>
						...
						<div class="light0">
								<input type="checkbox" class="radio1 http_status" checked="checked" value="200"/>
								<label class="label_c1">200</label>
								<input type="checkbox" class="radio1 http_status" checked="checked" value="301"/>
								<label class="label_c1">301</label>
								<input type="checkbox" class="radio1 http_status" checked="checked" value="302"/>
								<label class="label_c1">302</label>
								<label class="label_c1">其他：</label>
								<input type="text" class="style15" id="httpstatus">
						</div>
						<div class="clear"></div>
						<label class="label_more">&nbsp;</label>
		...
		<div class="edit_submit">
			<div class="btn_green" style=""><a id="website-save"><span class="spanL">保存监控项目</span><span class="spanR"></span></a></div>
