	...
	<div class="mainright" id="mainright">
		...
		<div class="edit_list">
			...
			<div class="rightcon_mid">
				...
				<div class="light0">
					您需要创建一个简单的php页面，并且将php页面放致可以访问的路径，需要您的环境已经安装memcached module,<a target="_blank" href="index.php?c=snmp&a=download&file=memcache">文件下载</a><br> 
					更多知识，您可以参考<a href="http://code.google.com/p/memcached/">http://code.google.com/p/memcached/</a>。
				</div>
				<div class="clear"></div>
				...
				<div class="more_class" id="more-class" style="display:<?php echo count($itemconfig)>1?'block':'none';?>;">
					...
					if(!empty($itemconfig['used_memory'])){?>
					<div class="col_4_con">
						  <div class="col_con4_list1 left"  >
							<div class="select_box" style="z-index: 1; position: relative; width: 200px;">
								<input name="tag_input" class="tag_select tag_input memcache_norm" maxlength="20" readonly="readonly" value="Memcached使用内存"/>
								<ul class="tag_options" style="position: absolute; z-index: 999; width: 200px; display: none;">
									<li class="open tag_li">Memcached当前链接数</li>
									<li class="open_selected tag_li">Memcached使用内存</li>
								</ul>
							</div>
						  </div>
					...
					<div class="col_4_con">
						  <div class="col_con4_list1 left"  >
							<div class="select_box" style="z-index: 1; position: relative; width: 200px;">
								<input name="tag_input" class="tag_select tag_input memcache_norm" maxlength="20" readonly="readonly" value="Memcached当前链接数"/>
								<ul class="tag_options" style="position: absolute; z-index: 999; width: 200px; display: none;">
									<li class="open_selected tag_li">Memcached当前链接数</li>
									<li class="open tag_li">Memcached使用内存</li>
								</ul>
							</div>
						  </div>
						  <div class="col_con4_list2 left">
					...
					<div class="light0 left20">您可以通过设定合理的阀值，结合条件表达式，对Memcache各项指标进行合理的监控.</div>
				</div>
				<div class="clear"></div> 
			</div>
		...
		<div class="edit_submit">
			<div class="btn_green" style=""><a id="memcache-edit"><span class="spanL">编辑监控项目</span><span class="spanR"></span></a></div>
...
<script type="text/javascript" src="script/monitor/memcache.js"> </script>
