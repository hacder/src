...
<!--右侧内容开始-->
	<div class="mainright" id="mainright">
		...
		<div class="edit_list">
			...
			<!--one-->
				...
				<div class="rightcon_mid">
					...
					<div class="left"><input type="text" class="style5" placeholder="请输入域名" id="itemurl"/><span class="tips" style="margin-left:6px;"></span></div>
					<div class="clear"></div> 
					<label class="label_more">DNS查询类型：</label>
					<div class="left">
						<input type="radio" class="radio1 dns-type" value="A" name="dns-type" checked="checked"/>
						<label class="label_c2">A</label>
						<input type="radio" class="radio1 dns-type" value="MX" name="dns-type" />
						<label class="label_c2">MX</label>
						<input type="radio" class="radio1 dns-type" value="NS" name="dns-type" />
						<label class="label_c2">NS</label>
						<input type="radio" class="radio1 dns-type" value="CNAME" name="dns-type" />
						<label class="label_c2">CNAME</label>
						<input type="radio" class="radio1 dns-type" value="TXT" name="dns-type" />
						<label class="label_c2">TXT</label>
						<input type="radio" class="radio1 dns-type" value="ANY" name="dns-type" />
					...
					<div id="dns-A">
						...
						<div class="left">
							<input type="checkbox" class="radio1 dns-ip" name="dns-ip"/>
						</div>
						<div class="clear"></div> 
						<label class="label_more">&nbsp;</label>
						...
						<div class="inner_table" id="dns-ip" style="display:none;">
					...
					<div class="left">
						<input type="checkbox" class="radio1 dns-server" name="dns-server"/>
					</div>
					<label class="label_more">&nbsp;</label>
					<div class="light0">您可以使用特定的DNS服务器来解析以上域名。如不指定，OSA监控精灵会使用个分布式检测点的本地DNS服务器</div>
					<div class="clear"></div>
					<div id="dns-server" style="display:none;">
						<label class="label_more">DNS服务器：</label>
						<div class="left">
							<input type="text" value="" class="style5" id="dns-server-value"><span class="tips" style="margin-left:6px;"></span>
						</div>
						<div class="clear"></div> 
						<label class="label_more">&nbsp;</label>
		...
		<div class="edit_submit">
			<div class="btn_green" style=""><a id="dns-save"><span class="spanL">保存监控项目</span><span class="spanR"></span></a></div>
