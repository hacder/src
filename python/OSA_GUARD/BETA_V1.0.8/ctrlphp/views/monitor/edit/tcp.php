...
<!--右侧内容开始-->
		...
		<div class="edit_list">
			<!--one-->
				...
				<div class="rightcon_mid">
					...
					<div class="height10"></div>
					<label class="label_more"><span class="red">*</span>TCP端口号：</label>
					<div class="left"><input type="text" class="style5" placeholder="请输入端口号" id="tcp_port" value="<?php $itemconfig = jsonDecode($itemdata[0]['oItemConfig']);echo $itemconfig['port'];?>" /><span class="tips" style="margin:6px;"></span></div>
		...
		<div class="edit_submit">
			<div class="btn_green" style=""><a id="tcp-edit"><span class="spanL">编辑监控项目</span><span class="spanR"></span></a></div>
...
<script type="text/javascript" src="script/monitor/tcp.js"> </script>
