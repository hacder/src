	...
	<div class="mainright" id="mainright">
		...
		<div class="edit_list">
			...
			<div class="rightcon_mid">
				...
				<div class="light0">
					您需要创建一个简单的php页面，并且将php页面放致可以访问的路径，需要您的环境已经安装php-redis module,<a target="_blank" href="index.php?c=snmp&a=download&file=redis">文件下载</a><br> 
					更多知识，您可以参考<a href="http://code.google.com/p/php-redis">http://code.google.com/p/php-redis</a>。
				</div>
				<div class="clear"></div>
								
				<div class="height10"></div>
				<div class="btn_gray2 left20 mar20L">
					<a id="more-options"><span class="spanL">自定义报警指标</span><span class="spanR"></span></a>
				</div>
				<div class="more_class" id="more-class" style="display:<?php echo count($itemconfig)>1?'block':'none';?>;">
					...
					if(!empty($itemconfig['connected_clients'])){?>
					<div class="col_4_con">
						  <div class="col_con4_list1 left"  >
							<div class="select_box" style="z-index: 1; position: relative; width: 200px;">
								<input name="tag_input" class="tag_select tag_input redis_norm" maxlength="20" readonly="readonly" value="Redis链接客户数">
								<ul class="tag_options" style="position: absolute; z-index: 999; width: 200px; display: none;">
									<li class="open_selected tag_li">Redis链接客户数</li>
									<li class="open tag_li">Redis使用内存</li>
									<li class="open tag_li">Redis命中率</li>
								</ul>
							</div>
						  </div>
						  ...
						  <div class="col_con4_list3 left" >
							<input type="text"  value="<?php echo $itemconfig['connected_clients']['value']?>" class="threshold left"><span class="left threshold-tips"></span>
						  </div>
					...
					<?php } if(!empty($itemconfig['used_memory'])){?>
					<div class="col_4_con">
						  <div class="col_con4_list1 left"  >
							<div class="select_box" style="z-index: 1; position: relative; width: 200px;">
								<input name="tag_input" class="tag_select tag_input redis_norm" maxlength="20" readonly="readonly" value="Redis使用内存">
								<ul class="tag_options" style="position: absolute; z-index: 999; width: 200px; display: none;">
									<li class="open tag_li">Redis链接客户数</li>
									<li class="open_selected tag_li">Redis使用内存</li>
									<li class="open tag_li">Redis命中率</li>
								</ul>
							</div>
						  </div>
						  ...
						  <div class="col_con4_list3 left" >
							<input type="text"  value="<?php echo $itemconfig['used_memory']['value']?>" class="threshold left"><span class="left threshold-tips">KB</span>
						  </div>
						  <div class="col_con4_list4 left" >
							<div class="btn_gray3">
								<a class="del-options"><span class="spanL">删除</span><span class="spanR"></span></a>
					...
					<?php }if(!empty($itemconfig['index_rate'])){ ?>
					<div class="col_4_con">
						  <div class="col_con4_list1 left"  >
							<div class="select_box" style="z-index: 1; position: relative; width: 200px;">
								<input name="tag_input" class="tag_select tag_input redis_norm" maxlength="20" readonly="readonly" value="Redis命中率">
								<ul class="tag_options" style="position: absolute; z-index: 999; width: 200px; display: none;">
									<li class="open tag_li">Redis链接客户数</li>
									<li class="open tag_li">Redis使用内存</li>
									<li class="open_selected tag_li">Redis命中率</li>
								</ul>
							</div>
						  </div>
						  <div class="col_con4_list2 left">
						  ...
						  <div class="col_con4_list3 left" >
							<input type="text"  value="<?php echo $itemconfig['index_rate']['value']?>" class="threshold left"><span class="left threshold-tips">%</span>
						  </div>
						  <div class="col_con4_list4 left" >
							<div class="btn_gray3">
								<a class="del-options"><span class="spanL">删除</span><span class="spanR"></span></a>
					...
					<div class="light0 left20">您可以通过设定合理的阀值，结合条件表达式，对Redis各项指标进行合理的监控.</div>
				</div>
				<div class="clear"></div> 		
			</div>
		...
		<div class="edit_submit">
			<div class="btn_green" style=""><a id="redis-edit"><span class="spanL">编辑监控项目</span><span class="spanR"></span></a></div>
...
<script type="text/javascript" src="script/monitor/redis.js"> </script>
