	...
	<div class="mainright" id="mainright">
		...
		<div class="edit_list">
			...
			<div class="rightcon_mid">
				...
				<div class="light0">请填写您的Lighttpd状态页面URL，比如：http://www.domain.com/server-status</div>
				<div class="clear"></div>
				
				<div class="innertxt_pro" style="width:700px;">
					<p>什么是Lighttpd状态页面？</p>	
					<p>Lighttpd通过mod_status模块提供了标准的运行时状态页面，配置它非常的简单，希望了解更多,您可以参考<a href="#">社区文档</a>。
					</p>
				</div>
				...
				<div class="more_class" id="more-class" style="display:<?php echo count($itemconfig)>1?'block':'none';?>;">
					...
					if(!empty($itemconfig['request_rate'])){?>
					<div class="col_4_con">
						  <div class="col_con4_list1 left"  >
							<div class="select_box" style="z-index: 1; position: relative; width: 200px;">
								<input name="tag_input" class="tag_select tag_input lighttpd_norm" maxlength="20" readonly="readonly" value="Lighttpd吞吐率">
								<ul class="tag_options" style="position: absolute; z-index: 999; width: 200px; display: none;">
									<li class="open tag_li">Lighttpd并发连接数</li>
									<li class="open_selected tag_li">Lighttpd吞吐率</li>
								</ul>
							</div>
						  </div>
						  ...
						  <div class="col_con4_list3 left" >
							<input type="text"  value="<?php echo $itemconfig['request_rate']['value']?>" class="threshold left"><span class="left threshold-tips">reqs/s</span>
						  </div>
					...
					<div class="col_4_con">
						  <div class="col_con4_list1 left"  >
							<div class="select_box" style="z-index: 1; position: relative; width: 200px;">
								<input name="tag_input" class="tag_select tag_input lighttpd_norm" maxlength="20" readonly="readonly" value="Lighttpd并发连接数">
								<ul class="tag_options" style="position: absolute; z-index: 999; width: 200px; display: none;">
									<li class="open_selected tag_li">Lighttpd并发连接数</li>
									<li class="open tag_li">Lighttpd吞吐率</li>
								</ul>
							</div>
						  </div>
						  <div class="col_con4_list2 left">
					...
					<div class="light0 left20">您可以通过设定合理的阀值，结合条件表达式，对Lighttpd各项指标进行合理的监控.</div>
				</div>
				<div class="clear"></div> 	
			</div>
		...
		<div class="edit_submit">
			<div class="btn_green" style=""><a id="lighttpd-edit"><span class="spanL">编辑监控项目</span><span class="spanR"></span></a></div>
...
<script type="text/javascript" src="script/monitor/lighttpd.js"> </script>
