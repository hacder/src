	...
	<div class="mainright" id="mainright">
		...
		<div class="edit_list">
			...
			<div class="rightcon_mid">
				...
				<div class="left"><input type="text" class="style5" placeholder="请输入MYSQL用户名" id="mysqluser"/><span class="tips" style="margin-left:6px;"></span></div>
				<div class="clear"></div> 
				...
				<div class="left"><input type="password" class="style5" placeholder="请输入MYSQL密码" id="mysqlpass"/><span class="tips" style="margin-left:6px;"></span></div>
				<div class="clear"></div> 
				<label class="label_more">&nbsp;</label>
				...
				<div class="left"><input type="text" class="style5" placeholder="请输入MYSQL端口" id="mysqlport"/><span class="tips" style="margin-left:6px;"></span></div>
				<div class="clear"></div> 
				<label class="label_more">&nbsp;</label>
				...
				<div class="left"><input type="text" class="style5" placeholder="请输入服务器IP或域名" id="itemurl"/><span class="tips" style="margin-left:6px;"></span></div>
				<div class="clear"></div> 
				<div class="height10"></div>
		...
		<div class="edit_submit">
			<div class="btn_green" style=""><a id="mysql-save"><span class="spanL">保存监控项目</span><span class="spanR"></span></a></div>
