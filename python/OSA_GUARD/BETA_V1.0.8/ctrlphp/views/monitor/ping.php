...
<!--右侧内容开始-->
		...
		<div class="edit_list">
			...
			<!--one-->
				...
				<div class="rightcon_mid">
					...
					<div class="left"><input type="text" class="style5" placeholder="请输入域名或ip" id="itemip" /><span class="tips"></span></div>
		...
		<div class="edit_submit">
			<div class="btn_green" style=""><a id="ping-save"><span class="spanL">保存监控项目</span><span class="spanR"></span></a></div>
