...
<!--右侧内容开始-->
		...
		<!--右侧title开始-->	
			<div class="currtitle">
				<div class="placing"><span>当前位置：</span><span>日常监控</span> <span>&gt;</span><span>未发送告警通知(服务器监控)</span></div>
			</div>	
			<div class="time_pro" style="display:block;text-align:left;margin-bottom:0px;">
				<p>
					<span class="time_pro_img"></span>
					<span >未发送告警信息的主要原因为可能有:1,超过了 告警通知设定的 当天最大发送次数;2,个性设置中的拒绝接收或暂停接收的告警消息;3,周末设定需要下周一才发送的短信.
					</span>
				</p>
			</div>	
			<div class="time_sel">
				...
				<table cellspacing="0" class="totable">
					<thead>
						<tr>
							...
							<th class="totd4"><span>监控服务器</span></th>
					...
					<table cellspacing="0" class="totable">
						<tbody>
							<tr>
								...
								<td class="totd4"><div><?php echo $data['oDevName'];?></div></td>
								<td class="totd5"><div><?php echo $data['oIp'];?></div></td>
