...
<div class="main">
<!--左侧菜单开始-->
	<?php include 'views/paint/redis/menu.php'?>
<!--左侧菜单结束-->
<!--右侧内容开始-->
	<div class="mainright" id="mainright">
	<!--右侧title开始-->	
		<div class="currtitle">
			<div class="placing"><span>当前位置：</span><span>图形报表</span> <span>&gt;</span> <span>Redis执行命令数每分钟</span></div>
		</div>
		<!--右侧title结束-->
		<!--右侧content开始-->
		<div class="edit_list">
			...
			<div class="rightcon_mid"  id="rightcon_mid" >
				<div class="wids_container" >
					<div id="commandmin" class="wids_cols ui-sortable" style="width:70%;height:280px;padding:0;">
					        ...
					        charts = new Highcharts.Chart({
					            ...
					            tooltip: {
					                formatter: function() {
					            		...
					            		return ''+'时间:'+date +'<br >'+this.series.name+': '+ this.y +'个/分钟';								                  
					                }
					            },
					            plotOptions: {
					                area: {
