...
<div class="main">
<!--左侧菜单开始-->
	<?php include 'views/paint/server/menu.php'?>
<!--左侧菜单结束-->
<!--右侧内容开始-->
	<div class="mainright" id="mainright">
	<!--右侧title开始-->	
		<div class="currtitle">
			<div class="placing"><span>当前位置：</span><span>图形报表</span> <span>&gt;</span> <span>服务器使用内存 </span></div>
		</div>
		<!--右侧title结束-->
		<!--右侧content开始-->
		<div class="edit_list">
			...
			<?php include 'views/paint/serverinfo.php';?>
			<!--one-->
			...
			<div class="rightcon_mid"  id="rightcon_mid" >
				<div class="wids_container" >
					<div id="memory-real" class="wids_cols ui-sortable" style="width:70%;height:280px;padding:0;">
						<script type="text/javascript">
						 	var chart;
						    $(document).ready(function() {
						        chart = new Highcharts.Chart({
						            chart: {
						                renderTo: 'memory-real',
						                type: 'area'
						            },
						            credits : {
										enabled:false
						            ...
						            tooltip: {
						                formatter: function() {
						            		...
						            		return ''+'时间:'+date+'<br >'+this.series.name+':'+ this.y+' Gbytes';					                  
						                }
						            },
						            plotOptions: {
						                area: {
					                ...
					                series: [ <?php echo $memory['real'];?>]
						        });
						    });
						</script>
					</div>
					<div class="height10"></div>
					<div id="memory-swap" class="wids_cols ui-sortable" style="width:70%;height:280px;padding:0;">
						<script type="text/javascript">
						 	var chart;
						    $(document).ready(function() {
						        chart = new Highcharts.Chart({
						            chart: {
						                renderTo: 'memory-swap',
						                type: 'area'
						            },
						            credits : {
										enabled:false
					                ...
					                series: [ <?php echo $memory['swap'];?>]
						        });
						    });
						</script>
					</div>
					<div class="height10"></div>	
					<div id="memory-rate" class="wids_cols ui-sortable" style="width:70%;height:280px;padding:0;">
						<script type="text/javascript">
						 	var chart;
						    $(document).ready(function() {
						        chart = new Highcharts.Chart({
						            chart: {
						                renderTo: 'memory-rate',
						                type: 'area'
						            },
						            credits : {
										enabled:false
						            ...
						            tooltip: {
						                formatter: function() {
						                	...
						                	var date = mydate.getHours()+":"+mydate.getMinutes()+":"+mydate.getSeconds();
						                	date = year+"-"+month+"-"+day+" "+date;
						            		return ''+'时间:'+date+'<br >'+this.series.name+': '+ this.y*100 +' %';					                  
						                }
						            },
						            plotOptions: {
						                area: {
