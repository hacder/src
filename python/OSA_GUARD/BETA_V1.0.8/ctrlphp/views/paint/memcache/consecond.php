...
<!--右侧内容开始-->
	...
	<!--右侧title开始-->	
		<div class="currtitle">
			<div class="placing"><span>当前位置：</span><span>图形报表</span> <span>&gt;</span> <span>Memcache连接数每秒</span></div>
		</div>
		<!--右侧title结束-->
		<!--右侧content开始-->
		<div class="edit_list">
			...
			<div class="rightcon_mid"  id="rightcon_mid" >
				<div class="wids_container" >
					<div id="consecond" class="wids_cols ui-sortable" style="width:70%;height:280px;padding:0;">
