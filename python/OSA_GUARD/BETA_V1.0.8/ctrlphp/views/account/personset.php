		...
		<!--右侧content开始-->
			...
			<div class="time_pro" >
				<p>
					...
					<span>提示:配置修改后自动保存,个性化设定优先级别最高，您修改配置时请确保认真了解该配置项的含义，以免错失重要告警信息。需要了解更多告警配置，请参考<a href="#">告警通知设定</a>。</span>
				</p>
			</div>
			<!--one-->
				  ...
				  <div class="rightcon_mid">
				    <p>
						...
						<input type="radio" class="radio1 receive_set" name="receive_set" value="defaults" checked="checked" />
						<label class="label_c1">默认随时接收邮件</label>
						<input type="radio" class="radio1 receive_set" name="receive_set" value="next"/>
						<label class="label_c1">转存到下次接收</label>
						<input type="radio" class="radio1 receive_set" name="receive_set" value="refuse"/>
			...
			<!--two-->
				  ...
				  <div class="rightcon_mid">
				    <p>
						<label class="label14"></label>
						<input type="checkbox" class="radio1 infotype" checked="checked" value="1"/>
						<label class="label_c1">故障消息</label>
						<input type="checkbox" class="radio1 infotype" checked="checked" value="2"/>
						<label class="label_c1">系统消息</label>
						<input type="checkbox" class="radio1 infotype" checked="checked" value="3"/>
						<label class="label_c1">提醒消息</label>
						<input type="checkbox" class="radio1 infotype" checked="checked" value="4"/>
			...
			<!--three-->
				  ...
				  <div class="rightcon_mid">
					...
					<div class="height10"><input type="hidden" value="" id="itemip"/></div>
			...
			<!--
				  ...
				  <div class="rightcon_mid">
				    <p>
						<label class="label14"></label>
						<input type="checkbox" class="radio1 reportset" checked="checked" value="daily"/>
						<label class="label_c1">日报表</label>
						<input type="checkbox" class="radio1 reportset" checked="checked" value="weekly"/>
						<label class="label_c1">周报表</label>
						<input type="checkbox" class="radio1 reportset" checked="checked" value="month"/>
						<label class="label_c1">月报表</label>
						<input type="checkbox" class="radio1 reportset" checked="checked" value="years"/>
			...
			<!--five-->
				  ...
				  <div class="rightcon_mid">
				    <p>
						<label class="label14"></label>
						<input type="checkbox" class="radio1 switchset" value="email"/>
						<label class="label_c1">暂停所有邮件接收</label>
						<!--
						<input type="checkbox" class="radio1 switchset" value="sms"/>
						<label class="label_c1">暂停所有短信接收</label>
						<input type="checkbox" class="radio1 switchset" value="msn"/>
						<label class="label_c1">暂停所有ＭＳＮ接收</label>
						<input type="checkbox" class="radio1 switchset" value="gtalk"/>
