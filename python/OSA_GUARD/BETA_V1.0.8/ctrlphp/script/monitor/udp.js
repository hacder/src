$(document).ready(function(){
	...
	$("#udp_port").click(function(){
		$(this).parent().find(".tips").css({'color':'rgb(23,124,226)'}).html('');	
	});
	
	$("#udp_port").blur(function(){
		var port = $(this).val();
		if(port == ''){
	...
	$("#udp-save").click(function(){
		...
		var url = "index.php?c=monitor&a=udp_monitor";
		$.post(url,{
			'itemname':itemname,
			'itemip':itemip,
			'port':port,
	...
	$("#udp-edit").click(function(){
		...
		var url = "index.php?c=monitor&a=monitor_udp_edit";
		$.post(url,{
			'itemid':itemid,
			'itemname':itemname,
			'itemip':itemip,
