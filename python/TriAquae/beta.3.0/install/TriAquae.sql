...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `TriAquae` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$10000$lkH3vI84fjWd$8NIlJMF83vux1fXrkV6NRGbi7GQDIOTibY4/HJIG750=','2013-09-20 11:56:10',1,'admin','','','admin@company.com',1,1,'2013-09-20 10:41:03'),(2,'pbkdf2_sha256$10000$TcOtjz12WGd8$V/+nY7IZbkvmtHsMYUhY6hqJA/R6eZAao0Gp5H/QBFQ=','2013-09-20 11:47:31',0,'tri_user01','','','',0,1,'2013-09-20 10:46:20');
...
INSERT INTO `django_session` VALUES ('orngnkci8mzz14i1m0qwu96ebhtseo5v','Y2Q0YmZlMjU0NDNjZWNlNTliNTY5YmY2OGUzNzJkOTRmYTg1ZGU4YjqAAn1xAShVEl9hdXRoX3VzZXJfYmFja2VuZHECVSlkamFuZ28uY29udHJpYi5hdXRoLmJhY2tlbmRzLk1vZGVsQmFja2VuZHEDVQ1fYXV0aF91c2VyX2lkcQSKAQF1Lg==','2013-10-04 11:56:10');
...
INSERT INTO `hosts_ip` VALUES (1,'localhost','127.0.0.1',NULL,22,'linux',5,5,1,1,1,'2c','public','auth','MD5','triaquae_snmp','my_pass',0,0,0,0,0,0),(2,'www.baidu.com','61.135.169.105',NULL,22,'linux',5,5,1,1,1,'2c','public','auth','MD5','triaquae_snmp','my_pass',0,0,0,0,0,0),(3,'testServer1','10.98.33.226',NULL,22,'linux',5,5,1,0,1,'2c','public','auth','MD5','triaquae_snmp','my_pass',0,0,0,0,0,0);
...
INSERT INTO `hosts_ip_group` VALUES (1,1,1),(2,2,1),(4,3,2);
...
INSERT INTO `hosts_serverstatus` VALUES ('127.0.0.1','localhost','UP','rtt min/avg/max/mdev = 0.022/0.023/0.024/0.000 ms','2013_09_20 19:58:22','Unkown',0,0,140,15,'100'),('61.135.169.105','www.baidu.com','UP','rtt min/avg/max/mdev = 3.817/5.119/6.026/0.946 ms','2013_09_20 19:58:22','Unkown',0,0,138,0,'100'),('10.98.33.226','testServer1','UP','rtt min/avg/max/mdev = 0.211/0.749/1.021/0.381 ms','2013_09_20 18:48:17','Unkown',0,0,1,0,'100');
...
-- Dump completed on 2013-09-20 19:58:39
