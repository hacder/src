			  ...
			  <div class="main_right">
				  ...
				  <div class="rightcon_mid">
				      <p class="pheight1">
						...
						<input type="text" class="style5" id="proname"/>
						<span class="tips"></span>
					  </p>
					  <p class="pheight1">
					      <label class="label1">检测指定端口是否存活：</label>
						  <span class="style13"><input type="checkbox" class="style11 check_port" name="check_port" value="22" checked="checked"/>22</span>
						  <span class="style13"><input type="checkbox" class="style11 check_port" name="check_port" value="3306" />3306</span>
						  <span class="style13"><input type="checkbox" class="style11 check_port" name="check_port" value="21" />21</span>
						  <span class="style13"><input type="checkbox" class="style11 check_port" name="check_port" value="8080" />8080</span>
						  <span>其他：<input type="text" class="style17" id="input_port"></span>
...
<!--							  <span class="left mr10"><label class="ip_tips">192.168.0.32</label><img src="images/erase.png" class="delselectip ml5 pointer"/></span>-->
				  ...
				  <!--four-->
				  <p class="pheight specibut"><input type="button" class="enter" value="确定保存" id="portconfirm" /></p>
			  </div>
			  <!--右边结束-->
		  </div><!--content结束-->
		  <div id="shadow"></div>
