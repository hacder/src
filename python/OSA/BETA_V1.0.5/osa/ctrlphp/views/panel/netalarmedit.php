	<?php include 'views/header.php';?>
		  ...
		  <div class="content">
			  ...
			  <div class="main_right">
				  ...
				  <div class="rightcon_mid">
					  ...
					  <p class="pheight1"><label class="label6">*当峰值每秒超过：</label><input type="text" class="style17" id="topvalue" value="<?php echo $itemconfig['topvalue'];?>"/>MB 时发送通知消息!</p>
				  ...
				  <p class="pheight specibut"><input type="button" class="enter" value="确定保存" id="trafficedit"/></p>
			  </div>
			  <!--右边结束-->
		  </div><!--content结束-->
		  <div id="shadow"></div>
		  ...
		  <script type="text/javascript" src="script/panel/trafficalarm.js"></script>
