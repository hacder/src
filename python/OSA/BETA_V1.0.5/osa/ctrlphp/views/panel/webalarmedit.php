		  ...
		  <div class="content">
			  ...
			  <div class="main_right">
				  ...
				  <div class="rightcon_mid">
					  ...
					  <p class="pheight1"><label class="label6">*网页URL地址：</label><input type="text" class="style5" id="urlname" value="<?php echo $itemconfig['url'];?>"/><span class="tips"></span></p>
					  <p class="light1">输入需要监控的网页URL地址，仅能输入一个。例如：http://www.openwebsa.org</p>
					  <p class="pheight1"><label class="label6">*对比关键字：</label><input type="text" class="style5" id="prokey" value="<?php echo $itemconfig['keywords'];?>"/><span class="tips"></span></p>
					  <p class="pheight light1">可以输入需要对比的关键字，多个关键字用","分割。</p>
					  <p class="pheight1">
					      <label class="label6">正常HTTP状态码：</label>
						  <span class="style13"><input type="checkbox" class="style11 http_status" name="http_status" <?php echo strpos($itemconfig['httpcode'],'200')!==false?"checked='checked'":'';?> value="200"/>200</span>
						  <span class="style13"><input type="checkbox" class="style11 http_status" name="http_status" <?php echo strpos($itemconfig['httpcode'],'301')!==false?"checked='checked'":'';?> value="301"/>301</span>
						  <span class="style13"><input type="checkbox" class="style11 http_status" name="http_status" <?php echo strpos($itemconfig['httpcode'],'302')!==false?"checked='checked'":'';?> value="302"/>302</span>
						  <span>其他：<input type="text" class="style17" id="httpstatus" value="<?php echo trim(str_replace(array('200','301','302'),'',$itemconfig['httpcode']),',');?>"></span>
					  </p>
				  ...
				  <p class="pheight specibut"><input type="button" class="enter" value="确定保存" id="webalarmedit"/></p>
			  </div>
			  <!--右边结束-->
		  </div><!--content结束-->
		  <div id="shadow"></div>
