	<?php include 'views/header.php';?>
		  ...
		  <div class="content">
			  ...
			  <div class="main_right">
				  ...
				  <div class="rightcon_mid">
					  ...
					  <p class="pheight1"><label class="label6">*当登录用户数超过：</label><input type="text" class="style17" id="usernum" value="<?php echo $itemconfig['usernum'];?>"/>个 时发送通知消息!</p>
				 ...
				 <!--two-->
				  ...
				  <p class="pheight specibut"><input type="button" class="enter" value="确定保存" id="useralarmedit"/></p>
			  </div>
			  <!--右边结束-->
		  </div><!--content结束-->
		  <div id="shadow"></div>
		  ...
		  <script type="text/javascript" src="script/panel/usersalarm.js"></script>
