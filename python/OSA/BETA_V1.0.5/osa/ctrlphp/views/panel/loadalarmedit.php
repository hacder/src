	<?php include 'views/header.php';?>
		  ...
		  <div class="content">
			  ...
			  <div class="main_right">
				  ...
				  <div class="rightcon_mid">
					  ...
					  <p class="pheight1"><label class="label6">*当负载超过：</label><input type="text" class="style17" id="threshold" value="<?php echo $itemconfig['topvalue'];?>"/>时发送通知消息!</p>
					  <p class="light1">对服务器进行负载监控和报警，帮助您更好的监控服务器信息！</p>
				 ...
				 <?php include 'views/panel/commonedit.php';?>
				  <p class="pheight specibut"><input type="button" class="enter" value="确定保存" id="loadalarmedit" /></p>
			  </div>
			  <!--右边结束-->
		  </div><!--content结束-->
		  <div id="shadow"></div>
		  ...
		  <script type="text/javascript" src="script/panel/loadalarm.js"></script>
