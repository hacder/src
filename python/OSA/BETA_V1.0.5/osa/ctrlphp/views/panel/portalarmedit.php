	<?php include 'views/header.php';?>
			  ...
			  <div class="main_right">
				  ...
				  <div class="rightcon_mid">
				      <p class="pheight1">
						...
						<input type="text" class="style5" id="proname" value="<?php echo $alarminfo['oItemName'];?>"/>
						<span class="tips"></span>
					  </p>
					  <p class="pheight1">
					      <label class="label1">检测指定端口是否存活：</label>
						  <span class="style13"><input type="checkbox" class="style11 check_port" name="check_port" value="22" <?php echo strpos($itemconfig['portlist'],'22')!==false?"checked='checked'":'';?>/>22</span>
						  <span class="style13"><input type="checkbox" class="style11 check_port" name="check_port" value="3306" <?php echo strpos($itemconfig['portlist'],'3306')!==false?"checked='checked'":'';?> />3306</span>
						  <span class="style13"><input type="checkbox" class="style11 check_port" name="check_port" value="21" <?php echo strpos($itemconfig['portlist'],'21')!==false?"checked='checked'":'';?> />21</span>
						  <span class="style13"><input type="checkbox" class="style11 check_port" name="check_port" value="8080" <?php echo strpos($itemconfig['portlist'],'8080')!==false?"checked='checked'":'';?> />8080</span>
						  <span>其他：<input type="text" class="style17" id="input_port" value="<?php echo trim(str_replace(array('22','3306','21','8080'),'',$itemconfig['portlist']),',');?>"></span>
						  <span>多个端口，使用“,”分割</span>
					  </p>
					  <p class="pheight light1">对指定端口进行监控，更好的了解各服务的状态！</p>
				 ...
				 <?php include 'views/panel/commonedit.php';?>
				  <p class="pheight specibut"><input type="button" class="enter" value="确定保存" id="portalarmedit" /></p>
			  </div>
			  <!--右边结束-->
		  </div><!--content结束-->
		  <div id="shadow"></div>
		  ...
		  <script type="text/javascript" src="script/panel/portalarm.js"></script>
