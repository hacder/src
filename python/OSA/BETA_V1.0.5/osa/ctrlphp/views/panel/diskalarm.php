		  ...
		  <div class="content">
			  ...
			  <div class="main_right">
				  ...
				  <div class="rightcon_mid">
					  ...
					  <p class="pheight1"><label class="label6">*当分区使用超过：</label><input type="text" class="style17" value="98" id="threshold"/>% 时发送通知消息!</p>
...
<!--							  <span class="left mr10"><label class="ip_tips">192.168.0.32</label><img src="images/erase.png" class="delselectip ml5 pointer"/></span>-->
				 ...
				 <?php include 'views/panel/commonadd.php';?>
				  <!--four-->
				  <p class="pheight specibut"><input type="button" class="enter" value="确定保存" id="diskconfirm"/></p>
			  </div>
			  <!--右边结束-->
		  </div><!--content结束-->
		  <div id="shadow"></div>
