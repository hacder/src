		  ...
		  <div class="content">
			  ...
			  <div class="main_right">
				  ...
				  <div class="rightcon_mid">
				      <p class="pheight1"><label class="label5"><em class="em">*</em>设备名称：</label><input type="text" readonly="readonly" class="style5 hui" maxlength="50" id="devname" value="<?php echo $devinfo[0]['oDevName'];?>"/><span class="tips" style="margin-left:10px;"></span></p>
					  <p class="light pheight">描述设备信息，比如：shanghai_192.168.1.5_openweb.org</p>
		
				      <p class="pheight1"><label class="label5"><em class="em">*</em>IP：</label><input type="text" readonly="readonly" class="style5 hui" id="ipname" maxlength="50" value="<?php echo $devinfo[0]['oIp'];?>" /><span class="tips" style="margin-left:10px;"></span></p>
				  ...
				  <div class="rightcon_bottom"></div>
				  <p><input type="button" class="enter specibut" id="submit" value="确认编辑" /><input type="button" class="enter specibut" value="取消返回" onclick="window.location='index.php?c=device&a=index'" /></p>
				  <!--two-->
			  </div>
			  <!--右边结束-->
		  </div><!--content结束-->
