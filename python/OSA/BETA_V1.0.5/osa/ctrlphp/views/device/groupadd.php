			  ...
			  <div class="main_right">
			      <div class="linkmlist">
				      <div class="home_icom">
						  ...
						  <span class="font1">-创建分组</span>
					  </div>
				  </div>
				  <!--one-->
				  <div class="rightcon_title">基本信息</div>
				  <div class="rightcon_mid">
				      <p class="pheight"><label class="label5"><em class="em">*</em>分组名称：</label><input type="text" class="style5" id="groupname" /><span class="tips"></span></p>
					  <p><label class="label5">分组描述：</label><textarea class="textarea1" id="descript" name="textarea1"></textarea></p>
	...
	<!--							  <span class="left mr10"><label class="ip_tips">192.168.0.32</label><img src="images/erase.png" class="delselectip ml5 pointer"/></span>-->
					  ...
					  <div class="rightcon_bottom"></div>
				  <p><input type="button" class="enter specibut" id="group_add" value="确认添加" /><input type="button" class="enter specibut" value="取消返回" onclick="window.location='index.php?c=device&a=devgrouplist'" /></p>
				  <!--two-->
			  </div>
			  <!--右边结束-->
		  </div><!--content结束-->
