		  ...
		  <div class="content">
			  ...
			  <div class="main_right">
				  ...
				  <div class="rightcon_mid">
				      <p class="pheight1"><label class="label5"><em class="em">*</em>设备名称：</label><input type="text" class="style5" maxlength="50" id="devname"/><span class="tips" style="margin-left:10px;"></span></p>
					  <p class="light pheight">描述设备信息，比如：shanghai_192.168.1.5_openweb.org</p>
				  	  <!-- modify start 2012-07-19 -->
				  	
					 <!--<div class="selected" style="margin-top:5px;">
					      <div style="float:left;"><label class="label5">请选择分组：</label></div>
					      <div style="width:630px;float:left;margin-bottom: 5px;" >
							<?php //foreach ($group as $key) {?>
				      			<span class=" mr10 style8"><input type="checkbox" class="style11" value='<?php //echo $key['id'];?>'><?php //echo $key['oGroupName'];?></span>
				      		<?php //}?>
						  </div>
					 </div>
				  	 --><!-- modify end 2012-07-19 -->
				      <p class="pheight1"><label class="label5"><em class="em">*</em>IP：</label><input type="text" class="style5" id="ipname" maxlength="50"/><span class="tips" style="margin-left:10px;"></span></p>
					  ...
					  <div class="clear"></div>
					  <p class="pheight"><label class="label5">详细地址：</label><input type="text" class="style5" id="address" maxlength="100"/></p>
					  ...
					  <p class="pheight">
					  		...
					  		<input type="text" class="style5 hui" id="add_time" maxlength="100" readonly="true"/>
					  </p>
					  <p class="pheight">
					  		<label class="label5">业务描述：</label>
					  		<input type="text" class="style5" id="business_des" maxlength="500"/>
					  </p>
				  ...
				  <div class="rightcon_mid">
				      <p class="pheight"><label class="label5">设备价格：</label><input type="text" class="style5" id="devprice" /></p>
				      <p class="light pheight">设备价格是指在采购设备时所花费的资金，单位：元</p>
				      <p class="pheight"><label class="label5">托管价格：</label><input type="text" class="style5" id="tgprice" /></p>
					  ...
					  <p class="light"><textarea class="textarea1" id="detail" name="textarea1"></textarea></p>				  
				  </div>
				  <div class="rightcon_bottom"></div>
  ...
  <div class="window " id="addgroup" style="display:none;">
		...
		<div class="window_con">
				 ...
				 <div class="clear"></div>
				 <br />
				 <p><label class="label5">分组描述：</label><textarea class="textarea1" id="description" name="textarea1"></textarea></p>
