		  ...
		  <div class="content">
			  ...
			  <div class="main_right">
			      <div class="linkmlist">
					  ...
					  <div class="setup">
					      <span class="setup_icon"><a href="index.php?c=maintain&a=addconfigupdate">添加配置更新计划</a></span>
					  </div>
				  </div>
				  ...
				  <div class="timepop" id="timepop" style="display:none;">
					  ...
					  <div class="timeFrame">
					      ...
					      <p><label class="label7">IP地址：</label><input type="text" class="style15" name="keyword" value="<?php echo $_SESSION['cupdatesearch'];?>"/></p>      
				  ...
				  <div class="knowledge_title">
				      <ul>
					       <li class="menuNo knows"  id="tab_li0" ><a href="index.php?c=maintain&a=configupdatelist&belong=0" >计划任务</a></li>
						   <li class="menuNo knows"  id="tab_li1" ><a href="index.php?c=maintain&a=configupdatelist&belong=1" >立即执行</a></li>
					  </ul>
				  </div>
