			  ...
			  <div class="main_right">
				  ...
				  <div class="timepop" id="timepop" style="display:none;">
					  ...
					  <div class="timeFrame">
					      ...
					      <p><label class="label7">IP地址：</label><input type="text" class="style15" name="keyword" value="<?php echo $_SESSION['batchsearch'];?>"/></p>      
				  ...
				  <div class="knowledge_title">
				      <ul>
					       <li class="menuNo knows"  id="tab_li0" ><a href="index.php?c=maintain&a=batchlist&belong=0" >计划任务</a></li>
						   <li class="menuNo knows"  id="tab_li1" ><a href="index.php?c=maintain&a=batchlist&belong=1" >立即执行</a></li>
					  </ul>
				  </div>
