			  ...
			  <div class="main_right">
			      <div class="linkmlist">
				      <div class="home_icom">
						  ...
						  <span class="font1">-运维知识库</span>
					  </div>
					  <div class="setup">
					      <span class="setup_icon"><a href="index.php?c=maintain&a=addknow">添加新知识</a></span>
					  </div>
				  </div>
				  ...
				  <div class="timepop" id="timepop" style="display:none;">
				      <div class="time_pro">
					      <p><img src="../images/icon2.gif" />注：请在以下日历中分别点选开始日期和结束日期，关键词可搜索知识标题、标签。</p>
					  </div>
					  ...
					  <div class="timeFrame">
					      ...
					      <p><label class="label7">关键词：</label><input type="text" class="style15" name="keyword" value="<?php echo $_SESSION['knowsearch'];?>"/></p>      
				  ...
				  <div class="knowledge_title">
				      <ul>
					       <li class="menuNo knows"  id="tab_li0" ><a href="index.php?c=maintain&a=knowlist&belong=0" >个人知识库</a></li>
						   <li class="menuNo knows"  id="tab_li1" ><a href="index.php?c=maintain&a=knowlist&belong=1" >内部知识库</a></li>
						   <li class="menuNo knows"  id="tab_li2" ><a href="http://bbs.osapub.com/forum.php" target="_blank">线上知识库</a></li>
					  </ul>
				  </div>
				  <div class="knowledge_con tag1" style="display:block;">
					  <div class="table_setup1">
					      <table cellspacing="0" cellpadding="0" width="100%">
							...
							<?php foreach ($knowinfo as $key) {?>
								<tr>
									<td><input type="checkbox" value="<?php echo $key['id'];?>"  class="checkbox"/></td>
									<td>
										<span class="types_knowledge">[<?php echo $key['oTypeName'];?>]</span>
										<span class="left"><?php echo $key['oRepositoryTitle'];?></span>
<!--										<span class="correct" title="已分享"><img src="images/share.gif" /></span>-->
									</td>
									<td><?php echo $key['oUserName'];?></td>
									<td><a href="index.php?c=maintain&a=editknow&id=<?php echo $key['id'];?>">编辑</a>
									<?php 
									 if($belong == 0){
										if($key['oIsShare'] == 0){?>
									<a href="index.php?c=maintain&a=shareknow&id=<?php echo $key['id'];?>" class="share">分享</a>
									<?php } else {?>
										已分享
									<?php }}?>
									</td>
							...
							<?php }?>
							<tr>
							   <td class="td_chect" colspan="5"><span class="checkall"><input type="checkbox" class="style11" id="checkall"/>全选</span><span class="del"><input type="button" value="删除" class="delete" id="knowdel"/></span></td>  
							</tr>
							<tr>
