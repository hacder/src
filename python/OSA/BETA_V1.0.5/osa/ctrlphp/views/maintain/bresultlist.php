		  ...
		  <div class="content">
			  ...
			  <div class="main_right">
				  ...
				  <div class="knowledge_title">
				      <ul>
					       <li class="menuNo knows"  id="tab_li0" ><a href="index.php?c=maintain&a=bresultlist&belong=0" >计划任务</a></li>
						   <li class="menuNo knows"  id="tab_li1" ><a href="index.php?c=maintain&a=bresultlist&belong=1" >立即执行</a></li>
					  </ul>
				  </div>
				  <div class="knowledge_con tag1" style="display:block;">
					  <div class="table_setup1">
					      <table cellspacing="0" cellpadding="0" width="100%">
							...
							foreach ($rsinfo as $key) { ?>
							<tr>
							    <td><input type="checkbox" value="<?php echo $key['id'];?>"  class="checkbox"/></td>
								<td><?php osa_showbatch($key['oCmdType']);?></td>
								<td><?php echo $key['oClientip']?></td>
								<td><?php echo $key['oRunTime'];?></td>
								<td><?php echo osa_show_bresult($key['oResult']);?></td>
							</tr> 
							<?php }?>
						
							<tr>
							   <td class="td_chect" colspan="7"><span class="checkall"><input type="checkbox" class="style11" id="checkall"/>全选</span><span class="del"><input type="button" value="删除" class="delete" id="bresult_del"/></span></td>  
							</tr>
							<tr>
