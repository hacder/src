...
//检查修改路径的几个文件是否可写
		...
		if (iswriteable($OSA_PATH . 'unctrlpy/etc/config.py')){
			$unctrlpy_config=1;
		}else{
			$unctrlpy_config=0;
		}
...
$check_arg=array($ctrlphp_etc,$ctrlpy_config,$unctrlpy_config,$phpsession_path,$php_version,$php_pdo_mysql,$php_mbstring,$php_json,$php_curl,$osa_disk_check,$check_python,$ctrlphp_dir);
